...
export default function TermsOfServiceProfile() {
  return (
      ...
      <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          <View style={styles.logoContainer}>
            <Text style={styles.appTitle}>Trek</Text>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.sectionText}>
              על ידי הרשמה לאפליקציית Trek ושימוש בשירותיה, אתם מסכימים לתנאים אלה. 
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.sectionText}>
              Trek היא אפליקציה החיבור בין מטיילים לאנשי מקום, המאפשרת לכם:
